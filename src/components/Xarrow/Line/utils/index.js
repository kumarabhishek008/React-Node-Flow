...
export const factorDpathStr = (d, factor) => {
  let l = d.split(/(\d+(?:\.\d+)?)/);
  l = l.map((s) => {
...
// return relative,abs
export const xStr2absRelative = (str) => {
...
export const getShortestLine = (sPoints, ePoints) => {
